	...
	if self.NextCheck <= CurTime() then
		...
		for i=2,len+1 do
			...
			self.Tiles[i].drawfunc = function(phone,app,x,y)
				...
				surface.DrawTexturedRect( x + 2, y + 2, 24, 24 )
				draw.SimpleText(ARCPhone.Apps["contacts"]:GetNameFromNumber(number), "ARCPhone", x + 28, y+self.Tiles[len].h*0.5, Color(255,255,255,255), TEXT_ALIGN_LEFT,TEXT_ALIGN_TOP) 
				draw.SimpleText(ARCPhone.PhoneSys.CurrentCall.on, "ARCPhone", x + 28, y+self.Tiles[len].h*0.5, Color(255,255,255,255), TEXT_ALIGN_LEFT,TEXT_ALIGN_BOTTOM) 
			end
			--[[
			self.Tiles[i].OnPressed = function(phone,app)
				self.Tiles[i].color = Color(0,0,255,128)
		...
		for i=len+2,total+1 do
			...
			self.Tiles[i].drawfunc = function(phone,app,x,y)
				...
				surface.DrawTexturedRect( x + 2, y + 2, 24, 24 )
				draw.SimpleText(ARCPhone.Apps["contacts"]:GetNameFromNumber(number), "ARCPhone", x + 28, y+self.Tiles[len].h*0.5, Color(255,255,255,255), TEXT_ALIGN_LEFT,TEXT_ALIGN_TOP) 
				draw.SimpleText(ARCPhone.PhoneSys.CurrentCall.pending, "ARCPhone", x + 28, y+self.Tiles[len].h*0.5, Color(255,255,255,255), TEXT_ALIGN_LEFT,TEXT_ALIGN_BOTTOM) 
			end
			--[[
			self.Tiles[i].OnPressed = function(phone,app)
				self.Tiles[i].color = Color(0,0,255,128)
